...
var ASM_CONSTS = {
  5118492: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 5118547: ($0) => { performance.now = function() { return $0; }; },  
 5118595: ($0) => { performance.now = function() { return $0; }; },  
 5118643: () => { performance.now = Module['emscripten_get_now_backup']; }
};
