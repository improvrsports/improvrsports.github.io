...
var ASM_CONSTS = {
  5118364: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 5118419: ($0) => { performance.now = function() { return $0; }; },  
 5118467: ($0) => { performance.now = function() { return $0; }; },  
 5118515: () => { performance.now = Module['emscripten_get_now_backup']; }
};
